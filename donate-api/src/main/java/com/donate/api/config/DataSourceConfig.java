package com.donate.api.config;


import com.baomidou.mybatisplus.spring.MybatisSqlSessionFactoryBean;
import com.donate.api.property.AppProperty;
...
//    }
    ...
    @Bean
    @Qualifier("web")
    public SqlSessionFactory sessionFactory_web() throws Exception {
...
//        lsfb.setMapperLocations(new Resource[]{new ClassPathResource("mapper/*.xml")});
    ...
    static MapperScannerConfigurer mapperScannerConfigurer_web() {
        ...
        msc.setBasePackage("com.donate.dao.mapper");
